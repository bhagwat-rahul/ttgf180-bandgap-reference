...
N -140 -320 80 -320 {lab=VBGR}
N 80 -320 80 -260 {lab=VBGR}
N 80 -320 380 -320 {lab=VBGR}
N -100 -260 -40 -260 {lab=VGND}
N -40 -260 -40 -0 {lab=VGND}
N 120 -260 180 -260 {lab=VGND}
N 180 -260 180 -0 {lab=VGND}
...
spiceprefix=X
m=8}
C {symbols/ppolyf_u_1k.sym} 120 -170 0 1 {name=R1
W=1.18e-6
L=3e-6
model=ppolyf_u_1k
spiceprefix=X
m=1}
C {symbols/ppolyf_u_1k.sym} -100 -70 0 0 {name=R2
W=1e-6
L=62.65e-6
model=ppolyf_u_1k
spiceprefix=X
m=1}
C {symbols/ppolyf_u_1k.sym} 380 -150 0 1 {name=R3
W=1e-6
L=137e-6
model=ppolyf_u_1k
spiceprefix=X
